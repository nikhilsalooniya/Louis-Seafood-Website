...
const WhoWeAreSection: React.FC = () => {
  ...
  return (
    <section className="bg-white mt-10 py-12 px-4 md:px-16 flex flex-col md:flex-row items-center gap-10 max-w-7xl mx-auto">
      {/* Left - Image */}
      ...
      <div className="w-full md:w-1/2">
        <h2 className="text-3xl md:text-4xl font-bold text-theme-blue-2 mb-4 text-center md:text-left">
